...
const SMS_VERIFY_CODE = 'SMS_VERIFY'
const MESSAGE_TYPES = [INVITE_NEW_EMPLOYEE_MESSAGE_TYPE, REGISTER_NEW_USER_MESSAGE_TYPE, RESET_PASSWORD_MESSAGE_TYPE, SMS_VERIFY_CODE]
